...
const TractorDetail = () => {
  return (
    <div className=" grid grid-cols-1 xl:grid-cols-3 px-1 xl:px-3  xl:gap-x-6 gap-y-3 xl:gap-y-6 mt-6  xl:mt-10 mb-10 xl:mb-0 ">
      ...
      <div className="flex w-full  overflow-hidden bg-white rounded-lg card-shdow">
        ...
        <div className="px-4 py-2 -mx-3 ">
          <div className="mx-3 ">
            <span className="text-lg  font-semibold text-teal-500 ">Bigha</span>
            <p className="text-lg text-gray-600 font-bold">50</p>
          </div>
        </div>
      </div>
      <div className="flex w-full  overflow-hidden bg-white rounded-lg card-shdow">
        ...
        <div className="px-4 py-2 -mx-3 ">
          <div className="mx-3 ">
            ...
            <p className="text-lg text-gray-600 font-bold">10000</p>
          </div>
        </div>
      </div>
      <div className="flex w-full  overflow-hidden bg-white rounded-lg card-shdow">
      ...
      <div className="flex w-full  overflow-hidden bg-white rounded-lg card-shdow">
        ...
        <div className="px-4 py-2 -mx-3 ">
          <div className="mx-3 ">
            ...
            <p className="text-lg text-gray-600 font-bold">Harun</p>
          </div>
        </div>
      </div>
      <div className="flex w-full  overflow-hidden bg-white rounded-lg card-shdow">
        ...
        <div className="px-4 py-2 -mx-3 ">
          <div className="mx-3 ">
            ...
            <p className="text-lg text-gray-600 font-bold">500</p>
          </div>
        </div>
      </div>
      <div className="flex w-full  overflow-hidden bg-white rounded-lg card-shdow">
